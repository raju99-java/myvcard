...
<html class="h-100" lang="en">
    ...
    <head>
        ...
        <title>{{strip_tags(isset($title->content_body) && $title->content_body!=''?$title->content_body.'-Forgot password':'Fast Card-Forgot password') }}</title>
                        ...
                        <div class="form-input-content">
                            <div class="card login-form mb-0">
                                <div class="card-body pt-5">
                                    <a class="text-center" href="javascript:void();"> <h4>Forgot Password</h4></a>
                                    <form class="mt-5 mb-3 login-input" id="reset-password-form" action="{{ Route('set-password') }}" method="POST">
                                        @csrf
