                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <div class="table-scrollable">
                            <table class="table table-striped table-bordered table-advance table-hover datatable" width="100%" id="franchiseuser-table">
                                <thead>
                                    <tr>
                                        <th class="bold"> # </th>
...
//    });
    $(function () {
        $('#franchiseuser-table').DataTable({
            processing: false,
            serverSide: true,
            order: [[0, "desc"]],
            ajax: full_path + 'franchise-user',
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
