...
<section class="main-body-section">
    <div class="content-body">
        <h3 class="page-title">Franchises
            <small>Manage all the Franchises of the site from here</small>
        </h3>
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-haze bold uppercase">Franchises</span>
                        </div>
                        <div class="pull-right">
                            <a class="btn btn-success" href="{{ Route('franchise.create') }}"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a>&nbsp;
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-advance table-hover datatable" width="100%" id="customer-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="bold"> Total Registration </th>
                                        <th class="bold"> Month Registration </th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4>Do you want to delete this Franchise?</h4>
            </div>
            <div class="modal-footer">
                <form id="deletefranchiseFORM" action="" method="POST">
                    @csrf
                    @method('DELETE')
