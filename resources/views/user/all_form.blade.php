    ...
    <div class="content-body">
        ...
        if (Auth()->guard('frontend')->user()->payment_status == '1' && Auth()->guard('frontend')->user()->subscription_end >= Carbon\Carbon::now()->format('Y-m-d')) {
            ...
            <div class="container-fluid mt-3">
                ...
                <form class="mb-3 login-input" id="all-form" action="{{ Route('check-form') }}" method="POST">
                    @csrf
                    <label for="avatar">Choose your theme colour</label>
                    <div class="colornav-container d-flex">
                        <div class="colornav-item violate">
                            <input type="radio" name="theme_color" value="1" checked>
                            <div class="buttonn"><span></span></div>
                        </div>

                        <div class="colornav-item pink">
                            <input type="radio" name="theme_color" value="2">
                            <div class="buttonn"><span></span></div>
                        </div>

                        <div class="colornav-item blue">
                            <input type="radio" name="theme_color" value="3">
                            <div class="buttonn"><span></span></div>
                        </div>

                        <div class="colornav-item green">
                            <input type="radio" name="theme_color" value="4">
                            <div class="buttonn"><span></span></div>
                        </div>
                        <div class="colornav-item yellow">
                            <input type="radio" name="theme_color" value="5">
                            <div class="buttonn"><span></span></div>
                        </div>
                      <div class="colornav-item sky">
                        <input type="radio" name="theme_color" value="6">
                        <div class="buttonn"><span></span></div>
                      </div>
                    </div>
                    ...
                    <input type="url" name="website" id="website" placeholder="Website"  size="30" >
                    <div class="help-block" id="error-website"></div>

                    <label for="phone">Whatsapp Number</label>
                    <input type="tel" id="whatsapp_no" name="whatsapp_no" placeholder="Whatsapp No.." >
                    <div class="help-block" id="error-whatsapp_no"></div>

                    <label for="subject">Residential Address</label>
                    <textarea id="residential_address" name="residential_address" placeholder="Residential Address.." style="height:80px" ></textarea>
                    ...
                    <input type="text" id="pinterest" name="pinterest" placeholder="Pinterest url..">
                    ...
                    <input type="text" id="blogger" name="blogger" placeholder="Blogger url..">
                    ...
                    <input type="text" id="telegram" name="telegram" placeholder="Telegram url..">
                    ...
                    <input type="email" id="company_email" name="company_email"  placeholder="Company Email.." >
                    <div class="help-block" id="error-company_email"></div>

                    <label for="bnature">Nature of Business</label>
                    <input type="text" id="company_nature" name="company_nature" placeholder="Nature of Business.." >
                    <div class="help-block" id="error-company_nature"></div>

                    <label for="subject">About Us</label>
                    <textarea id="about_us" name="about_us" placeholder="About Us.." style="height:80px" ></textarea>
                    ...
                    <input type="text" id="product1_title" name="product1_title" placeholder="Title..." >
                    <div class="help-block" id="error-product1_title"></div>

                    <label for="subject">Product One Details</label>
                    <textarea id="product1_details" name="product1_details" placeholder="Details" style="height:80px" ></textarea>
                    <div class="help-block" id="error-product1_details"></div>

                    <label for="phone">Product One Price</label>
                    <input type="text" id="product1_price" name="product1_price" placeholder="Price" >
                    ...
                    <input type="text" id="product2_title" name="product2_title" placeholder="Title..." >
                    <div class="help-block" id="error-product2_title"></div>

                    <label for="subject">Product Two Details</label>
                    <textarea id="product2_details" name="product2_details" placeholder="Details" style="height:80px" ></textarea>
                    <div class="help-block" id="error-product2_details"></div>

                    <label for="phone">Product Two Price</label>
                    <input type="text" id="product2_price" name="product2_price" placeholder="Price" >
                    ...
                    <input type="text" id="product3_title" name="product3_title" placeholder="Title...">
                    <div class="help-block" id="error-product3_title"></div>

                    <label for="subject">Product Three Details</label>
                    <textarea id="product3_details" name="product3_details" placeholder="Details" style="height:80px"></textarea>
                    <div class="help-block" id="error-product3_details"></div>

                    <label for="phone">Product Three Price</label>
                    <input type="text" id="product3_price" name="product3_price" placeholder="Price">
                    ...
                    <input type="text" id="product4_title" name="product4_title" placeholder="Title...">
                    <div class="help-block" id="error-product4_title"></div>

                    <label for="subject">Product Four Details</label>
                    <textarea id="product4_details" name="product4_details" placeholder="Details" style="height:80px"></textarea>
                    <div class="help-block" id="error-product4_details"></div>

                    <label for="phone">Product Four Price</label>
                    <input type="text" id="product4_price" name="product4_price" placeholder="Price">
                    ...
                    <input type="text" id="product5_title" name="product5_title" placeholder="Title...">
                    <div class="help-block" id="error-product5_title"></div>

                    <label for="subject">Product Five Details</label>
                    <textarea id="product5_details" name="product5_details" placeholder="Details" style="height:80px"></textarea>
                    <div class="help-block" id="error-product5_details"></div>

                    <label for="phone">Product Five Price</label>
                    <input type="text" id="product5_price" name="product5_price" placeholder="Price">
                    ...
                    <input type="text" id="product6_title" name="product6_title" placeholder="Title...">
                    <div class="help-block" id="error-product6_title"></div>

                    <label for="subject">Product Six Details</label>
                    <textarea id="product6_details" name="product6_details" placeholder="Details" style="height:80px"></textarea>
                    <div class="help-block" id="error-product6_details"></div>

                    <label for="phone">Product Six Price</label>
                    <input type="text" id="product6_price" name="product6_price" placeholder="Price">
                    ...
                    <input type="text" id="product7_title" name="product7_title" placeholder="Title...">
                    <div class="help-block" id="error-product7_title"></div>

                    <label for="subject">Product Seven Details</label>
                    <textarea id="product7_details" name="product7_details" placeholder="Details" style="height:80px"></textarea>
                    <div class="help-block" id="error-product7_details"></div>

                    <label for="phone">Product Seven Price</label>
                    <input type="text" id="product7_price" name="product7_price" placeholder="Price">
                    ...
                    <input type="text" id="product8_title" name="product8_title" placeholder="Title...">
                    <div class="help-block" id="error-product8_title"></div>

                    <label for="subject">Product Eight Details</label>
                    <textarea id="product8_details" name="product8_details" placeholder="Details" style="height:80px"></textarea>
                    <div class="help-block" id="error-product8_details"></div>

                    <label for="phone">Product Eight Price</label>
                    <input type="text" id="product8_price" name="product8_price" placeholder="Price">
                    ...
                    <input type="text" id="product9_title" name="product9_title" placeholder="Title...">
                    <div class="help-block" id="error-product9_title"></div>

                    <label for="subject">Product Nine Details</label>
                    <textarea id="product9_details" name="product9_details" placeholder="Details" style="height:80px"></textarea>
                    <div class="help-block" id="error-product9_details"></div>

                    <label for="phone">Product Nine Price</label>
                    <input type="text" id="product9_price" name="product9_price" placeholder="Price">
                    ...
                    <input type="text" id="product10_title" name="product10_title" placeholder="Title...">
                    <div class="help-block" id="error-product10_title"></div>

                    <label for="subject">Product Ten Details</label>
                    <textarea id="product10_details" name="product10_details" placeholder="Details" style="height:80px"></textarea>
                    <div class="help-block" id="error-product10_details"></div>

                    <label for="phone">Product Ten Price</label>
                    <input type="text" id="product10_price" name="product10_price" placeholder="Price">
                    ...
                    <input type="text" id="youtube_video_1" name="youtube_video_1" placeholder="Youtube Video..">
                    <div class="help-block" id="error-youtube_video_1"></div>
                    <input type="text" id="youtube_video_2" name="youtube_video_2" placeholder="Youtube Video..">
                    ...
                    <h5>WALLET:</h5>
                    <input type="tel" id="gpay_number" name="gpay_number" placeholder="Gpay Mobile Number" >
                    ...
                    <input type="tel" id="phonepay_number" name="phonepay_number" placeholder="PhonePe Mobile Number">
                    ...
                    <input type="tel" id="paytm_number" name="paytm_number" placeholder="PayTM Mobile Number">
                    ...
                    <h5>UPI:</h5>
                    <input type="tel" id="upi_number" name="upi_number" placeholder="UPI Mobile Name">
                    ...
                    <input type="text" id="account_no" name="account_no" placeholder="Account no.." >
                    ...
                    <input type="text" id="account_holder" name="account_holder" placeholder="Account Holder..">
                    ...
                    <input type="text" id="micr_code" name="micr_code" placeholder="MICR Code.." >
                    <div class="help-block" id="error-micr_code"></div>
                    <label for="subject">Bank Address</label>
                    <textarea id="bank_address" name="bank_address" placeholder="Bank Address.." style="height:80px" ></textarea>
