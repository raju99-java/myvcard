    ...
    <div class="content-body">
        ...
        <div class="container-fluid mt-3">
            ...
            <form class="mb-3 login-input" id="edit-all-form" action="{{ Route('edit-check-form') }}" method="POST">
                ...
                <textarea class="ckeditor" id="about_us" name="about_us" placeholder="About Us.." style="height:80px">{!! isset($card['about_us'])?$card['about_us']:'' !!}</textarea>
                ...
                <div class="help-block" id="error-cv"></div>
