...
<li> <a href="{{ Route('customer.show', ['id' => base64_encode($model->id)]) }}">{{ $model->name }}</a></li>
        ...
        <div class="user-update">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal form-row-seperated" action="{{ Route('customer.update', ['id' => base64_encode($model->id)]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-body">
